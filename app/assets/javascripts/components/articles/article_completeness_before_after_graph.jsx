...
const ArticleCompletenessBeforeAfterGraph = createReactClass({
  displayName: 'ArticleCompletenessBeforeAfterGraph',
...
export default ArticleCompletenessBeforeAfterGraph;
